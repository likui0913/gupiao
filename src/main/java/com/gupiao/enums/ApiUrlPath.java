...
public enum ApiUrlPath {
    ...
    STOCK_ZH_A_HIST("api/public/stock_zh_a_hist?symbol=CODE_ID&period=daily&adjust=qfq&start_date=START_DATE&end_date=END_DATE",
            "东方财富-沪深京 A 股日频率数据; 历史数据按日频率更新, 当日收盘价请在收盘后获取"),
    STOCK_ZH_A_HIST_ALL("api/public/stock_zh_a_hist?symbol=CODE_ID&period=daily&adjust=qfq",
